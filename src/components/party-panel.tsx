	...
	return (
		<div className="flex w-full flex-col gap-1.5">
			<p className="text-right font-barlow text-base tracking-wide text-mw2-text-dim">
				{playerCount} player(s) in <span className="font-semibold text-mw2-highlight">Smyile</span>
				&apos;s party.
			</p>
	...
	return (
		<div className="flex w-full items-center justify-between bg-mw2-card-bg/80 px-4 py-2">
			...
			<div className="flex items-center gap-2">
				...
				<span className="font-michroma text-xl font-normal text-mw2-highlight">{level}</span>
			</div>
		</div>
	)
}
